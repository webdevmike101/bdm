<?php if(!defined('BASEPATH')) exit('No direct script access'); ?>	
	...
	<div id="editCDs"></div>
		<div id="editCDs_left" class="form">
				...
				<?php if(isset($_SESSION['total_songs']) && $_SESSION['total_songs'] > 0): ?>
					...
					<?php for($i = 1; $i <= $_SESSION['total_songs']; $i++): ?>
						<div class='song-title-div' id='song-title-div-<?=$i?>'>
							<label>Song <?=$i?></label>
							<input type='text' size='50' class='form_input' id='song-title-input-<?=$i?>' name='song_<?=$i?>' value='<?php echo($_SESSION["song_$i"]); ?>'/>
							<br/><div>
			...
			<div>
				<?=form_label('Image:', 'cd_image')?><!-- <input type='file' id='input_image_path' /> -->
